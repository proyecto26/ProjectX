...
/**
 * Actions to manage the workflows, we use a referenceId to identify the workflows running in the backend
 * The referenceId is generated by the frontend in order to identify a transaction
 * The referenceId is also used to update the workflow in the store
 */
